    ...
    <section id="home" className="flex flex-col items-center justify-center min-h-[80vh] gap-8 text-center px-4 scroll-mt-20 animate-fade-in scroll-smooth">
      <div className="flex flex-col items-center gap-4 group transition-transform duration-300 hover:scale-105 animate-reveal-in">
        <Image
          ...
          quality={100}
        />
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">Rayan KOUSSA</h1>
        <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-primary">Développeur Full-Stack Junior</h2>
        <p className="max-w-xl mx-auto text-sm sm:text-base md:text-lg text-muted-foreground mt-2 px-2">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full max-w-md px-4">
        <a href="/CV_Rayan_K.pdf" download target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
          <Button variant="default" className="w-full sm:w-auto">Télécharger le CV (PDF)</Button>
        </a>
        <Link href="/projects" className="w-full sm:w-auto">
          <Button variant="outline" className="w-full sm:w-auto">Voir projets</Button>
        </Link>
      </div>
      ...
      <section id="skills" ref={skillsRef} className="w-full max-w-5xl mt-12 sm:mt-16 mb-8 px-4 animate-fade-in-up group scroll-reveal">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-primary text-center">Stack technique</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {/* Frontend */}
          <div className="bg-card rounded-xl shadow p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '900ms'}}>
          ...
          {/* Backend */}
          <div className="bg-card rounded-xl shadow p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '1000ms'}}>
          ...
          {/* Frameworks/libs */}
          <div className="bg-card rounded-xl shadow p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '1100ms'}}>
            <h3 className="font-semibold text-base sm:text-lg mb-2">Frameworks / Libs</h3>
            <div className="flex flex-wrap gap-2 sm:gap-3">
          ...
          {/* Autres */}
          <div className="bg-card rounded-xl shadow p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '1200ms'}}>
            <h3 className="font-semibold text-base sm:text-lg mb-2">Autres</h3>
            <div className="flex flex-wrap gap-2 sm:gap-3">
      ...
      <div className="w-full max-w-5xl mt-16 sm:mt-20 md:mt-24 mb-16 sm:mb-20 md:mb-24 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 px-4 animate-fade-in-up" style={{animationDelay: '600ms'}}>
        <div className="bg-card rounded-xl shadow p-6 sm:p-8 md:p-10 flex flex-col gap-4 sm:gap-6 transition-transform duration-300 hover:scale-105 hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '700ms'}}>
          <h3 className="font-semibold text-lg sm:text-xl mb-2 text-primary">Parcours académique</h3>
          <Timeline />
        </div>
        <div className="bg-card rounded-xl shadow p-6 sm:p-8 md:p-10 flex flex-col gap-4 sm:gap-6 transition-transform duration-300 hover:scale-105 hover:shadow-primary/40 animate-fade-in-up border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100" style={{animationDelay: '800ms'}}>
          <h3 className="font-semibold text-lg sm:text-xl mb-2 text-primary">Expérience professionnelle</h3>
          <ul className="space-y-3 sm:space-y-4 text-left text-sm sm:text-base">
      ...
      {/* Section Langues */}
      <section className="w-full max-w-5xl mx-auto mt-8 sm:mt-10 mb-6 sm:mb-8 animate-fade-in-up group px-4" ref={langRef}>
        <div className="bg-card rounded-xl shadow p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 items-center border border-gray-300 dark:border-none bg-white/80 dark:bg-card/100">
          <h3 className="font-semibold text-base sm:text-lg mb-2">Langues</h3>
          <div className="flex flex-wrap gap-4 sm:gap-6 text-lg sm:text-2xl justify-center items-center">
            <span title="Français" className="flex items-center gap-1 sm:gap-2 transition-transform duration-300 hover:scale-110 hover:text-blue-600 text-sm sm:text-base">
              <ReactCountryFlag countryCode="FR" svg style={{ width: "1.5em", height: "1.5em" }} className="sm:!w-[2em] sm:!h-[2em]" />
              Natif
            </span>
            <span title="Anglais" className="flex items-center gap-1 sm:gap-2 transition-transform duration-300 hover:scale-110 hover:text-indigo-700 text-sm sm:text-base">
              <ReactCountryFlag countryCode="GB" svg style={{ width: "1.5em", height: "1.5em" }} className="sm:!w-[2em] sm:!h-[2em]" />
              C1
            </span>
            <span title="Arabe" className="flex items-center gap-1 sm:gap-2 transition-transform duration-300 hover:scale-110 hover:text-green-700 text-sm sm:text-base">
              <ReactCountryFlag countryCode="DZ" svg style={{ width: "1.5em", height: "1.5em" }} className="sm:!w-[2em] sm:!h-[2em]" />
              Natif
            </span>
          </div>
        </div>
